...
public class KKTV_HOME_LISTVIEW_Adapter extends BaseAdapter {
	...
	public void setListItems(List<Home_List_type> list){
		listItmes = list;
...
//	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.kktv_home_listview_item, null);
			viewHolder.img = (ImageView)convertView.findViewById(R.id.kktv_home_item_img);
			viewHolder.title = (TextView)convertView.findViewById(R.id.kktv_home_item_title);
		...
		if (type.getId() == 1) {
			...
			imageLoader.displayImage(type.getImg(), viewHolder.img, options);
		}
		return convertView;
	}
